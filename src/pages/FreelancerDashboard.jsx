...
// Bar chart – jobs vs applied proposals per month
...
export default function Dashboard() {
  // activeNav tracks which sidebar item is highlighted
          ...
          <div style={styles.chartsRow}>
            ...
            <div style={{ ...styles.card, flex: 2 }}>
              <div style={styles.cardHeader}>
                ...
                <div style={styles.legendRow}>
                  <span style={styles.legendDot("#ef4444")} /> Jobs
                  <span style={styles.legendDot("#6366f1")} /> Applied Proposals
                </div>
              </div>
            ...
            <div style={{ ...styles.card, flex: 1 }}>
              ...
              <div style={styles.pieLegend}>
                {analyticsData.map((d) => (
                  <div key={d.name} style={styles.pieLegendItem}>
                    <span style={{ ...styles.legendDotEl, background: d.color }} />
...
// ─────────────────────────────────────────────
// 4. STYLES OBJECT
//    Using plain JS objects (no CSS files needed).
//    Each key maps directly to a component above.
// ─────────────────────────────────────────────
...
const styles = {
  ...
  // Helper: returns a coloured dot span style (used inline)
  legendDot: (color) => ({
    display: "inline-block",
    width: 8,
    height: 8,
